var jpictura=jpictura||{};jpictura.debounce=function(t,i,e){var a;return function(){var n=this,o=arguments,r=function(){a=null,e||t.apply(n,o)},s=e&&!a;clearTimeout(a),a=setTimeout(r,i),s&&t.apply(n,o)}},jpictura.offWindowWidthResize=function(t){$(window).off("."+t)},jpictura.onWindowWidthResize=function(t,i){var e=$(window),a=e.width();e.on("resize."+t,function(){var t=e.width();a!==t&&(i(),a=t)})};var jpictura=jpictura||{};jpictura.heightCalculator=function(t,i,e){function a(t){n(t),o(t),s()}function n(t){var i=0,e=f.layout.idealRowHeight,a=f.layout.maxWidthHeightRatio;u=t/((t-i)/e+a)}function o(t){var i=0,e=f.layout.idealRowHeight,a=f.layout.maxWidthHeightRatio;a*e>=t?(f.debug&&d("The max width/height ratio "+a+" is too big for row width "+t+"px."),c=t*a):c=t/((t+i)/e-a)}function r(t,i){var e,a,n=0;do e=g(t,h,!1,f),e>i?c=h:u=h,s(u,c),a=!1,e>i&&(a=!0),i-e>f.algorithm.epsilon&&(a=!0),++n>=f.algorithm.maxIterationCount&&(a=!1);while(a);return n>=f.algorithm.maxIterationCount&&f.debug&&d("Max "+n+" iterations reached. Current precision: "+(i-e)+"."),h}function s(){h=(u+c)/2}function l(t,i,e){t=Math.floor(t);var a;do a=g(i,t,!0,f);while(e>a&&t++);return t}var u,c,h,d=i,g=t,f=e;this.getHeight=function(t,i){if(0===t.length)return 0;a(i);var e=r(t,i);return e=l(e,t,i)}};/*!
 * jPictura v1.1.9
